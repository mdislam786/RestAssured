...
public class Create_A_Product_Locally_And_Validate_In_Database {
	public static Properties prop;
	
	public Create_A_Product_Locally_And_Validate_In_Database() throws IOException {
		prop=new Properties();
	...
	public void create_Single_Product() {
		...
		Response response = 
				given()
				.log().all()
					.baseUri(prop.getProperty("baseURI_L"))
					.header("Content-Type", "application/json")
					.body(payload)
				.when()
					.post(prop.getProperty("endPoint_L"))
				.then()
					.log().body()
					.extract().response();
